...
//  seam Serpe had to cut before this plug-in could exist — while the header was
//  called `SerpeExtensionParameterAddresses.h` the kernel looked as though it
//  depended on the melody app.
//
//  Everything that is actually Serpe's — key, bars, surprise, freshness,
...
let SerpeParameterSpecs = ParameterTreeSpec {
