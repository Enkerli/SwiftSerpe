...
//  transcribing. MelGen's PORTING.md §5: "Swift Serpe can then go somewhere new
...
//  this plug-in stands on has a chord dictionary in it and Serpe never has.
//
...
struct SerpeState: Codable, Hashable, Sendable {
